...
- (void) initUserData
{
    
    {
        ...
        //zj007  万民 ＋
        //zj006  破碎
        _optTeam = [[NSMutableDictionary alloc] init];
        ...
        [_optTeam setObject:leader forKey:@"leader"];
        ...
        [_optTeam setObject:member1 forKey:@"member1"];
        ...
        [_optTeam setObject:member2 forKey:@"member2"];
        ...
        [_optTeam setObject:member3 forKey:@"member3"];
        ...
        [_optTeam setObject:member4 forKey:@"member4"];
        label5.text = [member4 objectForKey:@"name"];
        
        [_optTeam setObject:[NSNumber numberWithInt:16] forKey:@"groupid"];
        //zj003  剑舞
        [_optTeam setObject:@"ipadsan@126.com" forKey:@"zj001"];
        //zj004  万民 ＋
        [_optTeam setObject:@"kerry0214" forKey:@"zj007"];
        //zj006  破碎
        [_optTeam setObject:@"Kalio" forKey:@"zj006"];
