...
-(void) updateforce1
{
    ...
    if(_isLeader1ok == YES)
    {
        ...
        {
            ack1.title = [NSString stringWithFormat:@"攻击(%@)",[dict objectForKey:@"challenge"]];
            
            force1Info.stringValue = [NSString stringWithFormat:@"%@ (%@/%@)",[__force1 objectForKey:@"MainForceid"],[dict objectForKey:@"totalFood"],[dict objectForKey:@"pretectFood"]];
        }
    }
    ...
    if(_force1ok > 5 && _isLeader1ok == YES)
    {
        ...
        if(_isunblock1 == YES)
        {
            [force1unblock setTitle:@"加门板"];
        }
        else
        {
            [force1unblock setTitle:@"减门板"];
        }
    }
...
-(void) updateforce2
{
    ...
    if(_isLeader2ok == YES)
    {
        ...
        if([dict objectForKey:@"challenge"] != nil)
        {
            ack2.title = [NSString stringWithFormat:@"攻击(%@)",[dict objectForKey:@"challenge"]];
            
            force2Info.stringValue = [NSString stringWithFormat:@"%@ (%@/%@)",[__force2 objectForKey:@"MainForceid"],[dict objectForKey:@"totalFood"],[dict objectForKey:@"pretectFood"]];
        }
    }
    ...
    if(_force2ok > 5 && _isLeader2ok)
    {
        ...
        if(_isunblock2 == YES)
        {
            [force2unblock setTitle:@"加门板"];
        }
        else
        {
            [force2unblock setTitle:@"减门板"];
        }
    }
...
-(void) updateforce3
{
    ...
    if([self checksession:[__force3 objectForKey:@"leader"]] == YES)
    {
        ...
        if([dict objectForKey:@"challenge"] != nil)
        {
            ack3.title = [NSString stringWithFormat:@"%@(%@)",[__force3 objectForKey:@"MainForceid"],[dict objectForKey:@"challenge"]];
...
-(void) updateforce4
{
    ...
    if([self checksession:[__force4 objectForKey:@"leader"]] == YES)
    {
        ...
        if([dict objectForKey:@"challenge"] != nil)
        {
            ack4.title = [NSString stringWithFormat:@"%@(%@)",[__force4 objectForKey:@"MainForceid"],[dict objectForKey:@"challenge"]];
            [ack4 setEnabled:YES];
        }
...
-(void) updateforce5
{
    ...
    if([self checksession:[__force5 objectForKey:@"leader"]] == YES)
    {
        ...
        if([dict objectForKey:@"challenge"] != nil)
        {
            ack5.title = [NSString stringWithFormat:@"%@(%@)",[__force5 objectForKey:@"MainForceid"],[dict objectForKey:@"challenge"]];
            [ack5 setEnabled:YES];
        }
...
-(void) updateforce6
{
    ...
    if([self checksession:[__force6 objectForKey:@"leader"]] == YES)
    {
        ...
        if([dict objectForKey:@"challenge"] != nil)
        {
            ack6.title = [NSString stringWithFormat:@"%@(%@)",[__force6 objectForKey:@"MainForceid"],[dict objectForKey:@"challenge"]];
            [ack6 setEnabled:YES];
        }
