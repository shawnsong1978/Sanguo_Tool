...
@property (nonatomic,retain) IBOutlet  UIButton * ack1;
@property (nonatomic,retain) IBOutlet  UIButton * force1unblock;
@property (nonatomic,retain) IBOutlet  UILabel * force1Info;

@property (nonatomic,retain) IBOutlet  UIButton * ack2;
@property (nonatomic,retain) IBOutlet  UIButton * force2unblock;
@property (nonatomic,retain) IBOutlet  UILabel * force2Info;

@property (nonatomic,retain) IBOutlet  UIButton * ack3;
@property (nonatomic,retain) IBOutlet  UIButton * ack4;
@property (nonatomic,retain) IBOutlet  UIButton * ack5;
@property (nonatomic,retain) IBOutlet  UIButton * ack6;
